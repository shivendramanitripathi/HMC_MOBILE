...
class AppTheme {
  static final ThemeData theme1 = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(secondary: const Color(0xFFF47E20)),
  ...
  static final ThemeData theme2 = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(secondary: const Color(0xFF2EBD8D)),
    dialogTheme: const DialogTheme(
      backgroundColor: Colors.white,
  ...
  static final ThemeData theme3 = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(secondary: const Color(0xFF3B75F4)),
    dialogTheme: const DialogTheme(
      backgroundColor: Colors.white,
  ...
  static final ThemeData theme4 = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(secondary: const Color(0xFF24446F)),
    dialogTheme: const DialogTheme(
      backgroundColor: Colors.white,
  ...
  static final ThemeData theme5 = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(secondary: const Color(0xFFFE6760)),
    dialogTheme: const DialogTheme(
      backgroundColor: Colors.white,
  ...
  static final ThemeData theme6 = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch().copyWith(secondary: const Color(0xFF35BF91)),
    dialogTheme: const DialogTheme(
      backgroundColor: Colors.white,
